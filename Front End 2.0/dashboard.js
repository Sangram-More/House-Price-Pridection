...
imageSelect.addEventListener('change', () => {
    ...
    dashboardImage.src = `C:\Users\ASK\OneDrive\Desktop\Front-End Web Pages\Cross-Validation\Linear Regression.png`;
});
...
form.addEventListener('submit', function (event) {
    ...
    if (dataset === 'India CSV File' && crossValidation === 'yes' && model === "Linear Regression") {
        image.src = 'C:\Users\ASK\OneDrive\Desktop\Front-End Web Pages\Cross-Validation\Linear Regression.png';
    } else if (dataset === 'India CSV File' && crossValidation === 'no' && model === 'Linear Regression') {
        image.src = 'C:\Users\ASK\OneDrive\Desktop\Front-End Web Pages\Normal\Linear Regression-N.png';
    } else if (dataset === 'India CSV File' && crossValidation === 'yes' && model === 'Ridge Regression') {
        image.src = 'C:\Users\ASK\OneDrive\Desktop\Front-End Web Pages\Cross-Validation\Ridge Regression.png';
    } else if (dataset === 'India CSV File' && crossValidation === 'no' && model == 'Ridge Regression') {
        image.src = 'C:\Users\ASK\OneDrive\Desktop\Front-End Web Pages\Normal\Ridge Regression-N.png';
    } else if (dataset === 'India CSV File' && crossValidation === 'yes' && model == 'Lasso Regression') {
        image.src = 'C:\Users\ASK\OneDrive\Desktop\Front-End Web Pages\Cross-Validation\Lasso Regression.png';
    } else if (dataset === 'India CSV File' && crossValidation === 'no' && model == 'Lasso Regression') {
        image.src = 'C:\Users\ASK\OneDrive\Desktop\Front-End Web Pages\Normal\Lasso Regression-N.png';
    }
    imageContainer.appendChild('#image-select');
});